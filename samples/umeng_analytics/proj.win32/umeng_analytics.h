...
class CC_DLL Umeng_analyticsPlayer : public CCObject
{
public:
...
private:
    static Umeng_analyticsPlayer *s_sharedInstance;
    static Umeng_analyticsPlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    Umeng_analyticsPlayer(void);
