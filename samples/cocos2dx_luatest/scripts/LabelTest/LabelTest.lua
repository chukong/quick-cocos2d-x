...
function LabelTTFTest.create()
    ...
    item1:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, LabelTTFTest.setAlignmentLeft)
    local item2 = CCMenuItemFont:create("Center")
    item2:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, LabelTTFTest.setAlignmentCenter)
    local item3 = CCMenuItemFont:create("Right")
    item3:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, LabelTTFTest.setAlignmentRight)
    ...
    item1:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, LabelTTFTest.setAlignmentTop)
    item2 = CCMenuItemFont:create("Middle")
    item2:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, LabelTTFTest.setAlignmentMiddle)
    item3 = CCMenuItemFont:create("Bottom")
    item3:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, LabelTTFTest.setAlignmentBottom)
...
function BitmapFontMultiLineAlignment.create()
    ...
    longSentences:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, BitmapFontMultiLineAlignment.stringChanged)
    local lineBreaks    = CCMenuItemFont:create("Short Sentences With Intentional Line Breaks")
    lineBreaks:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, BitmapFontMultiLineAlignment.stringChanged)
    local mixed         = CCMenuItemFont:create("Long Sentences Mixed With Intentional Line Breaks")
    mixed:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, BitmapFontMultiLineAlignment.stringChanged)
    ...
    left:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, BitmapFontMultiLineAlignment.alignmentChanged)
    local center        = CCMenuItemFont:create("Center")
    center:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, BitmapFontMultiLineAlignment.alignmentChanged)
    local right         = CCMenuItemFont:create("Right")
    right:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, BitmapFontMultiLineAlignment.alignmentChanged)
