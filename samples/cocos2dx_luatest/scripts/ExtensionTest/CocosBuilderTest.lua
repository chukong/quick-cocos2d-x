...
local function onMenuTestClicked()
    ...
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestMenus.ccbi",proxy,HelloCocosBuilderLayer)
...
local function onSpriteTestClicked()
    ...
    local scene  = CCScene:create()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestSprites.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    if nil ~= HelloCocosBuilderLayer["mTestTitleLabelTTF"] then
        local ccLabelTTF = tolua.cast(HelloCocosBuilderLayer["mTestTitleLabelTTF"],"CCLabelTTF")
        if nil ~= ccLabelTTF then
...
local function onButtonTestClicked()
    ...
    local scene  = CCScene:create()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestButtons.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    if nil ~= HelloCocosBuilderLayer["mTestTitleLabelTTF"] then
        local ccLabelTTF = tolua.cast(HelloCocosBuilderLayer["mTestTitleLabelTTF"],"CCLabelTTF")
        if nil ~= ccLabelTTF then
...
local function onAnimationsTestClicked()
    ...
    local scene  = CCScene:create()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestAnimations.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    if nil ~= HelloCocosBuilderLayer["mTestTitleLabelTTF"] then
        local ccLabelTTF = tolua.cast(HelloCocosBuilderLayer["mTestTitleLabelTTF"],"CCLabelTTF")
        if nil ~= ccLabelTTF then
...
local function onParticleSystemTestClicked()
    ...
    local scene  = CCScene:create()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestParticleSystems.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    if nil ~= HelloCocosBuilderLayer["mTestTitleLabelTTF"] then
        local ccLabelTTF = tolua.cast(HelloCocosBuilderLayer["mTestTitleLabelTTF"],"CCLabelTTF")
        if nil ~= ccLabelTTF then
...
local function onScrollViewTestClicked()
    local scene  = CCScene:create()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestScrollViews.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    if nil ~= HelloCocosBuilderLayer["mTestTitleLabelTTF"] then
        local ccLabelTTF = tolua.cast(HelloCocosBuilderLayer["mTestTitleLabelTTF"],"CCLabelTTF")
        if nil ~= ccLabelTTF then
...
local function onTimelineCallbackSoundClicked()
    ...
    local scene  = CCScene:create()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/ccb/TestTimelineCallback.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    if nil ~= HelloCocosBuilderLayer["mTestTitleLabelTTF"] then
        local ccLabelTTF = tolua.cast(HelloCocosBuilderLayer["mTestTitleLabelTTF"],"CCLabelTTF")
        if nil ~= ccLabelTTF then
...
local function HelloCCBTestMainLayer()
    local  proxy = CCBProxy:create()
    local  node  = CCBuilderReaderLoad("ccb/HelloCocosBuilder.ccbi",proxy,HelloCocosBuilderLayer)
    local  layer = tolua.cast(node,"CCLayer")
    return layer
end
