...
function CreateBackMenuItem()
    ...
    MenuItem:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, MainMenuCallback)
...
function Helper.initWithLayer(layer)
    ...
    item1:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, Helper.backAction)
    item2:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, Helper.restartAction)
    item3:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, Helper.nextAction)
