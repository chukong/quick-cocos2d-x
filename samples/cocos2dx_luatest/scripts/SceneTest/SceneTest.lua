...
SceneTestLayer1 = function()
    ...
    item1:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onPushScene)
    local  item2 = CCMenuItemFont:create( "Test pushScene w/transition")
    item2:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onPushSceneTran)
    local  item3 = CCMenuItemFont:create( "Quit")
    item3:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onQuit)
...
SceneTestLayer2 = function()
    ...
    item1:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onReplaceScene)
    local  item2 = CCMenuItemFont:create( "replaceScene w/transition")
    item2:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onReplaceSceneTran)
    local  item3 = CCMenuItemFont:create( "Go Back")
    item3:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onGoBack)
    local arr = CCArray:create()
    arr:addObject(item1)
    arr:addObject(item2)
    arr:addObject(item3)
...
SceneTestLayer3 = function()
    ...
    item0:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, item0Clicked)
    local item1 = CCMenuItemFont:create("Touch to popScene")
    item1:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, item1Clicked)
    local item2 = CCMenuItemFont:create("Touch to popToRootScene")
    item2:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, item2Clicked)
