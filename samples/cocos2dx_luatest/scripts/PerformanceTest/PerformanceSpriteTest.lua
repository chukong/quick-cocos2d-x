...
local function initWithLayer(layer, controlMenuVisible)
	...
	mainItem:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, toPerformanceMainLayer)
...
local function initWithMainTest(scene, asubtest, nNodes)
	...
	decrease:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onDecrease)
    decrease:setColor(ccc3(0, 200, 20))
    local increase = CCMenuItemFont:create(" + ")
	increase:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, onIncrease)
    ...
    for i = 1, 9 do
		...
		itemFont:addScriptEventListener(cc.MENU_ITEM_CLICKED_EVENT, testNCallback)
        --itemFont:setTag(i)
