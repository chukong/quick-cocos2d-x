...
local function ActionCardinalSpline()
	...
	array:add(ccp(0, 0))
	array:add(ccp(size.width / 2 - 30, 0))
	array:add(ccp(size.width / 2 - 30, size.height - 80))
	array:add(ccp(0, size.height - 80))
	array:add(ccp(0, 0))
...
local function ActionCatmullRom()
    ...
    array:add(ccp(0, 0))
    array:add(ccp(80, 80))
    array:add(ccp(size.width - 80, 80))
    array:add(ccp(size.width - 80, size.height - 80))
    array:add(ccp(80, size.height - 80))
    array:add(ccp(80, 80))
    array:add(ccp(size.width / 2, size.height / 2))
    ...
    array2:add(ccp(size.width / 2, 30))
    array2:add(ccp(size.width  -80, 30))
    array2:add(ccp(size.width - 80, size.height - 80))
    array2:add(ccp(size.width / 2, size.height - 80))
    array2:add(ccp(size.width / 2, 30))
