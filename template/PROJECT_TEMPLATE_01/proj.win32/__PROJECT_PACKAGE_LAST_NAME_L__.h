...
class CC_DLL __PROJECT_PACKAGE_LAST_NAME_UF__Player : public CCObject
{
public:
...
private:
    static __PROJECT_PACKAGE_LAST_NAME_UF__Player *s_sharedInstance;
    static __PROJECT_PACKAGE_LAST_NAME_UF__Player *sharedInstance(void);
    static void purgeSharedInstance(void);

    __PROJECT_PACKAGE_LAST_NAME_UF__Player(void);
