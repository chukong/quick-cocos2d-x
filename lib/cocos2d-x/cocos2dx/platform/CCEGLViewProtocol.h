...
public:
     ...
     * @lua NA
     */
    virtual void handleTouchesBegin(int num, size_t ids[], float xs[], float ys[]);
    /**
     * @lua NA
     */
    virtual void handleTouchesMove(int num, size_t ids[], float xs[], float ys[]);
    /**
     * @lua NA
     */
    virtual void handleTouchesEnd(int num, size_t ids[], float xs[], float ys[]);
    /**
     * @lua NA
     */
    virtual void handleTouchesCancel(int num, size_t ids[], float xs[], float ys[]);
...
private:
    void getSetOfTouchesEndOrCancel(CCSet& set, int num, size_t ids[], float xs[], float ys[]);
