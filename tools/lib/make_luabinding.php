...
Usage:
    make_luabinding [-d output_dir] [-o output_filename] [-E KEY=VALUE] pkg_filename

Example:
    -- create files MyClasses_luabinding.cpp, MyClasses_luabinding.h
    make_luabinding MyClasses_luabinding.pkg

    -- create files MyClasses_binding.cpp, MyClasses_binding.h
    make_luabinding -o MyClasses_binding MyClasses_luabinding.pkg

    -- set MACRO for tolua++
    make_luabinding -E CCOBJECTS=MyClass,MyClass2 MyClasses_luabinding.pkg
...
// call builder
require(__DIR__ . '/make_luabinding_functions.php');
